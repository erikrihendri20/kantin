...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <button id="button-cart-navbar" style="border: none; background-color: transparent;" class="nav-link" href="<?= base_url('Pembeli/Pesan/cart'); ?>">
          <i class="fas fa-shopping-cart"></i>
          <span class="badge badge-danger navbar-badge" id="cart-navbar"></span>
        </button>
      </li>
      <?php endif ?>
