...
<!-- codemirror -->
<!-- <script src="<?= base_url('assets/admin-lte/plugins/codemirror/codemirror.js'); ?>"></script>
<script src="<?= base_url('assets/admin-lte/plugins/codemirror/mode/css/css.js'); ?>"></script>
<script src="<?= base_url('assets/admin-lte/plugins/codemirror/mode/xml/xml.js'); ?>"></script>
<script src="<?= base_url('assets/admin-lte/plugins/codemirror/mode/htmlmixed/htmlmixed.js'); ?>"></script> -->
