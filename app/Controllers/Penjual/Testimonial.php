...
class Testimonial extends BaseController
{
    ...
    public function index()
    {
        $data = [
            ...
            'nav' => [
                [
                    'title' => 'Testimonial',
                    'url' => 'Penjual/Testimonial'
                ],
            ],
            'plugins' => [],
            'styles' => 'penjual/testimonial/index',
            'visitor' => count($this->user_log_model->getVisitor()),
            'scripts' => 'penjual/testimonial/index'
        ];
        return view('penjual/testimonial/index' , $data);  
    }
    ...
    public function sendTestimonial()
    {
        ...
        if(!$this->validate($rules)){
            ...
            return redirect()->to(base_url('Penjual/Testimonial'))->withInput();
        }
        $data = [
        ...
        session()->setFlashdata('flash' , implode('|' , $alert));
        return redirect()->to(base_url('Penjual/Testimonial'));
    }
}
